...
async function buildFullState(DRINKS) {
  ...
  return { locations, roomStock, roomStockHistory, stock, drinksMenu: DRINKS, staffList, locationsList: LOCATIONS, rates, settings, shrinkageCharges, shrinkageDebtPlans };
}
